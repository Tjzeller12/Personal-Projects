...
This frame is full of text fields so the user can enter statistics and add a stocks to the the "ListOfStocks.txt" text file. This text file acts as a data base that
contains all the stocks that can be accessed in this program. If there are no stocks in this text file the user will not be able to compare any
stocks. Finally, the fourth button is simply an exit button. When clicked the program closes.
